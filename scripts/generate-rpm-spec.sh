...
ffmpeg_dev_fedora="ffmpeg-free-devel"
ffmpeg_dev_opensuse="ffmpeg-5-libavcodec-devel ffmpeg-5-libavformat-devel ffmpeg-5-libavutil-devel"

cat "${specdir}/nautilus-avinfo.spec.template" | VERSION=${version} FFMPEG_DEV=${ffmpeg_dev_fedora} envsubst > "${specdir}/nautilus-avinfo.fc.spec"
